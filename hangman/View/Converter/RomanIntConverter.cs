...
{
    internal class RomanToIntConverter : Base.View.Converter.BaseConverter
    {
        protected readonly Dictionary<char, int> RomanNumberDictionary;
        protected readonly Dictionary<int, string> NumberRomanDictionary;
